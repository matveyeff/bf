...
"use strict";!function(){var e=document.querySelectorAll(".slide"),s=document.querySelectorAll(".slider__control"),l=e.length,r=!1;function t(){if(!r){r=!0;var e=this,s=e.classList.contains("m--right"),t=document.querySelector(".slide.s--active"),c=+t.dataset.slide;s?c++:c--,c<1&&(c=l),l<c&&(c=1);var i=document.querySelector(".slide-"+c);e.classList.add("a--rotation"),t.classList.remove("s--active","s--active-prev"),document.querySelector(".slide.s--prev").classList.remove("s--prev"),i.classList.add("s--active"),s||i.classList.add("s--active-prev");var a=c-1;a<1&&(a=l),document.querySelector(".slide-"+a).classList.add("s--prev"),setTimeout(function(){e.classList.remove("a--rotation"),r=!1},975)}}[].slice.call(e).forEach(function(e,s){var t=s+1;e.classList.add("slide-"+t),e.dataset.slide=t}),[].slice.call(s).forEach(function(e){e.addEventListener("click",t)})}();
