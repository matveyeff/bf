...
$(document).ready(function(){$(".slider").slick({infinite:!0,slidesToShow:1,slidesToScroll:1,speed:400,arrows:!1,autoplay:!0,autoplaySpeed:5e3,cssEase:"ease",dots:!0})});var menu=document.getElementById("menu"),nav=document.getElementById("nav"),close=document.getElementById("close");menu.addEventListener("click",function(e){e.preventDefault(),nav.style.display="flex",close.style.display="flex",menu.style.display="none"}),close.addEventListener("click",function(e){e.preventDefault(),nav.style.display="none",close.style.display="none",menu.style.display="flex"}),$(window).on("load",function(){$(".preloader").delay(500).fadeOut("slow",function(){$(this).attr("style","display: none !important")})}),document.addEventListener("appReady.EappsInstagramFeed",function(){$(".my-instashow").eappsInstagramFeed({api:"/instashow/api/index.php",source:"@beauty_force.ru",width:"auto",layout:"grid",columns:4,rows:2,lang:"ru",colorGridLoadMoreButton:"rgb(0, 53, 51)"})}),baguetteBox.run(".baguetteBoxThree",{animation:"fadeIn",noScrollbars:!0,captions:!1}),$("#mainform").submit(function(){var e=$(this).serialize();return $.ajax({type:"POST",url:"../send.php",data:e,success:function(){document.querySelector(".modal").style.display="flex"}}),!1}),$('[name="phone"]').mask("+7 (999) 999-99-99"),document.querySelector("#formbutton").onclick=function(){document.querySelector(".modal").style.display="none"};
